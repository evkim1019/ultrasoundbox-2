const cardioBlockList = [
  // Block 1
  {
    ...
    usviews: ['/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/ECHO_Normal-EF-PSL_2.gif', '/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/L-Ant-Lung_5.gif', '/cardiothoracic/block1/good_normal_PS.gif'],
    questionInfo: [
      {
        qtype: 'reading',
  ...
  // Block 2
  {
    categoryId: 1,
    props: '47yo female came in with shortness of breath, pleuritic pain and tachycardia. She takes over the counter contraceptives. Please perform a point-of-care ECHO and obtain any needed views. You perform a POCUS:',
    usviews: ['/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif', '/cardiothoracic/block3/ECHO_McConnells_Sign_3.gif' ],
    questionInfo: [
      {
        qtype: 'reading',
        question: 'Do you see any Pericardial effusion? If so, is there evidence of tamponode physiology',
